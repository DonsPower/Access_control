...
function Header()
{
    ...
    $this->Ln(10);
    $this->Cell(80);
    $this->Cell(10,5,utf8_decode('ANEXO 9.1'));
    // Salto de línea
    $this->Ln(10);
    $this->Cell(50);
    ...
    $this->Ln(3);
    $this->Cell(80);
    $this->Cell(10,5,utf8_decode('POR SISMO '));
    // Salto de línea
    $this->Ln(10);
}
...
function Datos1 ($header)
   {
    ...
    $this->Ln();
    $this->SetFont('Times','B',10);
    $this->Cell(120,5,utf8_decode("¿Cuenta con salidas de emergencia señalizadas?"),1);
    $this->SetFont('Times','',10);
    $this->Cell(70,5,utf8_decode($_POST['salemergencia']),1);
    $this->Ln();
    $this->SetFont('Times','B',10);
    $this->Cell(120,5,utf8_decode("¿Las salidas de emergencia pueden ser utilizadas?"),1);
    $this->SetFont('Times','',10);
    $this->Cell(70,5,utf8_decode($_POST['utilizadas']),1);
    $this->Ln();
    $this->SetFont('Times','B',10);
    $this->Cell(120,5,utf8_decode("¿Las zonas de seguridad son de fácil acceso y están señalizadas?"),1);
    $this->SetFont('Times','',10);
    $this->Cell(70,5,utf8_decode($_POST['zonas']),1);
    $this->Ln();
    $this->SetFont('Times','B',10);
