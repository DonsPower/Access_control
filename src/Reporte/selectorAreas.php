...
<head>
    ...
    <body>
    <form action="reporteSismoAreas.php" method="POST">
    <div class="container" >
 ...
 <div class="col-sm-12" style="margin-top:10%; text-align: center;">
   ...
   <br>
                <select name="repSismo" class="col" id="repSismo" required="required" >
           ...
           <br><br><br><br>
            <th><input type="submit" class=" btn btn-primary btn-lg" value="Reporte Sismo"></th>
        </div>
      </div>
        </div>
      </div>
