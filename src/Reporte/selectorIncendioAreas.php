...
<head>
  ...
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-giJF6kkoqNQ00vy+HMDP7azOuL0xtbfIcaT9wjKHr8RbDVddVHyTfAAsrekwKmP1" crossorigin="anonymous">
    ...
    <body>
    <form action="reporteIncendioAreas.php" method="POST">
    <div class="container" >
...
<div class="col-sm-12" style="margin-top:10%; text-align: center;">
  ...
  <br>
                <select name="repIncendio" class="col" id="repIncendio" required="required" >
            ...
            <br><br><br><br>
            <th><input type="submit" class=" btn btn-primary btn-lg" value="Reporte Incendio"></th>
        </div>
