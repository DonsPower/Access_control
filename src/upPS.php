...
$query=mysqli_query($conex, "SELECT * FROM  administradores  WHERE email ='".$email."' and preguntaS='".$preguntaS."' and respuestaS='".$respuestaS."'");
$nr = mysqli_num_rows($query);

if($nr==1){
    header("Location:  cambiarPS.php?dato=2&var1=$email&var2=$preguntaS&var3=$respuestaS");
}else{
    header ("refresh:1; url=preguntaSeguridad.php?dato=1");
}
