...
<body>
<form action="upPS.php" method="POST">
  <div class="container">
     ...
     <div class="row ">
      ...
      <div class="col-sm-5" style="margin-top:10%; text-align: center;">
		...
		<h1 vertical-align:middle>   Restablecer Contraseña </h1>
            ...
            <br>
            <input type="text" name="preguntaS" placeholder="Pregunta de seguridad"/>
            <br>
            <input type="text" name="respuestaS" placeholder="Respuesta de seguridad"/>
            <br>
