...
<input type="checkbox" id="check">
  ...
  <header>Dashboard</header>
      ...
      <a href="#"><i class="fas fa-user-plus"></i>Visitantes</i></a>
            ...
            <div class="container ">
                <div class="row">
                    ...
                    <h5 class="card-title" style="margin-top: 10px;">Total administradores</h5>
                      ...
                      <a id="totalAdmin" class="btn btn-primary" style="float:right; margin-bottom:10px; width:100px;">Ir <i class="fas fa-arrow-right"></i></a>
                    </div>
                    </div>
                    </div>
                    <?php
